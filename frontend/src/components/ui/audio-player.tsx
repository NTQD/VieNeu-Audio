...
// DA BO: AudioPlayerProgress (dung @radix-ui/react-slider - du an nay dung
// Base UI, khong Radix, xem components.json) va exampleTracks (demo data tro
// toi CDN cua ElevenLabs). Ghep/seek thuc te dung AudioScrubber trong
// waveform.tsx (canvas thuan, khong phu thuoc thu vien slider nao) thay vi
// AudioPlayerProgress.
...
export const AudioPlayerTime = ({
  ...
  return (
    <span
      {...otherProps}
      className={cn("text-muted-foreground text-sm tabular-nums font-mono", className)}
    >
      {formatTime(time)}
    </span>
  )
