...
> This is the `vieneu` Python SDK's own documentation (installation, SDK
> usage, model backbones). It moved here from the repo root on 2026-09-15
> so the root `README.md` could document **VoxDirector AI**, the
> multi-agent audiobook pipeline this repo also hosts, built on top of this
> SDK. Nothing below changed otherwise.
